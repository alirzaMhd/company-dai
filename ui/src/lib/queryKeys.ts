export const queryKeys = {
  ...
  agents: {
    ...
    adapterModels: (companyId: string, adapterType: string, adapterConfig?: Record<string, unknown>) =>
      ["agents", companyId, "adapter-models", adapterType, adapterConfig] as const,
