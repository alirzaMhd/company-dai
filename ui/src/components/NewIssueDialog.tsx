  ...
  const { data: assigneeAdapterModels } = useQuery({
    queryKey:
      effectiveCompanyId && assigneeAdapterType
        ? queryKeys.agents.adapterModels(effectiveCompanyId, assigneeAdapterType, assigneeAgent?.adapterConfig)
        : ["agents", "none", "adapter-models", assigneeAdapterType ?? "none", assigneeAgent?.adapterConfig],
    queryFn: () => agentsApi.adapterModels(effectiveCompanyId!, assigneeAdapterType!, assigneeAgent?.adapterConfig),
