...
export function OnboardingWizard() {
  ...
  const adapterConfig = useMemo(() => buildAdapterConfig(), [adapterType, model, command, args, url, tunnelUrl]);
  ...
  const {
    ...
    queryKey: createdCompanyId
      ? queryKeys.agents.adapterModels(createdCompanyId, adapterType, adapterConfig)
      : ["agents", "none", "adapter-models", adapterType, adapterConfig],
    queryFn: () => agentsApi.adapterModels(createdCompanyId!, adapterType, adapterConfig),
  ...
  function buildAdapterConfig(): Record<string, unknown> {
    ...
    const config = adapter.buildAdapterConfig({
      ...
      args,
      url,
      tunnelUrl: adapterType === "opencode_remote" ? tunnelUrl : undefined,
