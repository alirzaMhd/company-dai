...
export const heartbeatRuns = pgTable("heartbeat_runs", {
    ...
    retryOfRunId: uuid("retry_of_run_id").references(() => heartbeatRuns.id, {
        onDelete: "set null",
    }),
    ...
    companyLivenessIdx: index("heartbeat_runs_company_liveness_idx").on(table.companyId, table.livenessState, table.createdAt),
}));
